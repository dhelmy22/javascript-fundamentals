    ...
    return(
        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <p>
                    This web app is intended to be a starter/tutorial app for your upcoming project and a learning sandbox for the months and years to come, should you continue to develop web apps with React. In this application we will work through some of the basic React concepts, build out some small applications, and then unleash you to build your own personal web applications.
                </p>
                <hr />
                ...
                <ul>
                    ...
                    <li>Refactor the text on this page and make this your own site.</li>
